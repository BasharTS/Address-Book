		...
		<div id = 'mainContent_reg' >
			<?php
				if(isset($_POST['submit'])){
					...
					if($firstName != '' && $lastName != '' && $phoneNumber != '' && $state != '') {
						$insertResult = $Engine->insertData($userpic, $firstName, $lastName, $nickName, $gender, $phoneNumber,$emailAddress, $state, $department);
			...
			<div id = 'formSection' >
				<form method = 'POST' action = '' enctype = 'multipart/form-data' >
					...
					<input type = 'text' name = 'firstName' id = 'firstName' value = '<?=$firstName?>' placeholder = 'First name' /> <br />
					<!-- <label for="lastName">&nbsp Last Name</label><br /> -->
					<input type = 'text' name = 'lastName' id = 'lastName' value = '<?=$lastName?>' placeholder = 'Last name' /> <br />
					<!-- <label for="nickName">&nbsp Nickname</label><br /> -->
					<input type = 'text' name = 'nickName' id = 'nickName' value = '<?=$nickName?>' placeholder = 'Nickname' /> <br />
					...
					<input type = 'text' name = 'phoneNumber' id = 'phoneNumber' value = '<?=$phoneNumber?>' placeholder = 'Phone Number' /> <br />
					<!-- <label for="emailAddress">&nbsp Email Address</label><br /> -->
					<input type ='text' name ='emailAddress' id = 'emailAddress' value = '<?=$emailAddress?>' placeholder = 'Email Address' /> <br />
					<!-- <label for="state">&nbsp State</label><br /> -->
					<input type = 'text' name = 'state' id = 'state' value = '<?=$state?>' placeholder = 'State/Hometown' /> <br />
					<!-- <label for="department">&nbsp Department</label><br /> -->
					<input type = 'text' name = 'department' id = 'department' value = '<?=$department?>' placeholder = 'Department/Unit' /> <br />
